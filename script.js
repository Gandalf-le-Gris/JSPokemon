...
function battleEncounter(encounter, fixedPokemon) {
    ...
    clearBody();
    fadeInTransition();
    gArea = new gameArea('https://api.allorigins.win/raw?url=https://raw.githubusercontent.com/Gandalf-le-Gris/JSPokemon/main/resources/sprites/battle_backgrounds/cave2.png', () => { });
    gArea.start();
