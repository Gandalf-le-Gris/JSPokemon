...
function damageCalculator(move, pA, pD) {
    ...
    if (move.cat === "physical") {
        ...
        if (crit) {
            ...
            defMul = Math.max(1, statsChangeMultiplier ** pD.statchanges.spdefense);
        } else {
...
function Venusaur() {
    ...
    this.moves = [createMove("tackle"), createMove("tackle"), createMove("vine_whip"), createMove("poison_powder")];
    this.movepool = ["vine_whip", "poison_powder", "leech_seed"];
...
function Charizard() {
    ...
    this.moves = [createMove("scratch"), createMove("scratch"), createMove("ember"), createMove("wing_attack")];
    this.movepool = ["ember", "wing_attack", "flamethrower"];
...
function Pikachu() {
    ...
    this.currenthp = 0;
    this.types = ["electric"];
    this.moves = [createMove("tackle"), createMove("tackle"), createMove("thunder_shock"), createMove("quick_attack")];
    this.movepool = ["thunder_shock", "quick_attack", "nuzzle"];
...
function Garchomp() {
    ...
    this.moves = [createMove("tackle"), createMove("tackle"), createMove("dual_chop"), createMove("sand_tomb")];
    this.movepool = ["dual_chop", "sand_tomb", "crunch"];
...
function Cinderace() {
    ...
    this.currenthp = 0;
    this.types = ["fire"];
    this.moves = [createMove("tackle"), createMove("tackle"), createMove("ember"), createMove("quick_attack")];
    this.movepool = ["ember", "quick_attack", "pyro_ball"];
...
movesList = ["ancient_power", "assurance", "aura_sphere", "beat_up", "bite", "bullet_punch", "confusion", "crunch", "dazzling_gleam", "detect",
    ...
    "surging_strikes", "shadow_ball", "dream_eater", "sticky_web", "rest", "play_rough", "earthquake", "judgment", "hyper_beam"];
...
function isGrounded(p) {
    ...
    return i >= 0 && p.effects[i].stacks > 0 || contains(p.types, "flying");
}
